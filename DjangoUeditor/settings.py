...
UEditorSettings={
    ...
    "defaultPathFormat":"article/%(basename)s_%(datetime)s_%(rnd)s.%(extname)s"   #默认保存上传文件的命名方式
}
...
UEditorUploadSettings={
   #上传图片配置项
    ...
    "imageUrlPrefix":"http://res.myforum.com/",
    "imagePathFormat":"",
    ...
    "scrawlUrlPrefix":"http://res.myforum.com/",
    "scrawlPathFormat":"",

    #截图工具上传 */
    "snapscreenActionName": "uploadimage", #执行上传截图的action名称 */
    "snapscreenPathFormat":"",
    "snapscreenUrlPrefix":"http://res.myforum.com/",
    ...
    "catcherUrlPrefix":"http://res.myforum.com/",
    #上传视频配置 */
    "videoActionName": "uploadvideo", #执行上传视频的action名称 */
    "videoPathFormat":"",
    "videoFieldName": "upfile", # 提交的视频表单名称 */
    "videoMaxSize": 102400000, #上传大小限制，单位B，默认100MB */
    "videoUrlPrefix":"http://res.myforum.com/",
    "videoAllowFiles": [
    ...
    "fileUrlPrefix": "http://res.myforum.com/",#文件访问路径前缀 */
    "fileAllowFiles": [
    ...
    "imageManagerListPath":"/usr/share/userres/article/",
    "imageManagerListSize": 30, #每次列出文件数量 */
    "imageManagerAllowFiles": [".png", ".jpg", ".jpeg", ".gif", ".bmp"], #列出的文件类型 */
    "imageManagerUrlPrefix": "http://res.myforum.com/article/",#图片访问路径前缀 */

    #列出指定目录下的文件 */
    "fileManagerActionName": "listfile", #执行文件管理的action名称 */
    "fileManagerListPath":"/usr/share/userres/article/",
    "fileManagerUrlPrefix": "http://res.myforum.com/article/",
